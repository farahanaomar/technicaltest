...
<head>
<title>Profile</title>
<!--This is participant view profile page-->
...
<form name="form1" action="log_out.php" method="post">
<div class="about-section">
	<br><table border=2 align=center bordercolor="#ee4e2c" background-color="#fc5e00">
	<th colspan=2 id="ROW2"><h1>Webinar Shopee Link</h1>
	<p>Google Meet only! <br>Click link below</p>
	
	</th>
	
	<tr id="ROW1">
		<td><p style="text-align:center">			
		<a href="https://meet.google.com/afm-hmfc-jaf">Link Here</a></p></td>
	</tr>
	
	<th colspan=2><input type = submit value=Logout></th>
